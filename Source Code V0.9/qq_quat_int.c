...
//In a fundmantal domain, take geodesics going between sides i1<=i2 and j1, j2. This returns 1 if they are guarenteed to intersect, -1 if they do not, and 0 if this is not enough info (which is the case iff {i1, i2, j1, j2} has at most 3 distinct elements).
static int sides_int_indices(long i1, long i2, long j1, long j2){
  if(j1==i1) return 0;
  int left1;
