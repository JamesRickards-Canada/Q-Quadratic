...
/*
GP;addhelp(bqf_int, "This package deals with intersections of binary quadratic forms with integer coefficients. \n Subtopics:\n Computing intersection numbers(intcomp)\n Properties of an intersection (intprop)");
GP;addhelp(intcomp,"ibqf_int, ibqf_intRS, ibqf_intforms, ibqf_intformsRS, ibqf_intformsRO, ibqf_intformsLS, ibqf_intformsLO.");
GP;addhelp(intprop,"bqf_bdelta, bqf_intlevel, ibqf_intpoint, hdist.");
*/
